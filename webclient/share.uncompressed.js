...
(function() {
    ...
    Doc = (function() {
        function Doc(connection, name, openData) {
            ...
            this.snapshot = openData.snapshot;
            if (openData.type) {
    ...
    Connection = (function() {
        function Connection(host, authentication, shardId) {
            var _this = this;
            this.docs = {};
            ...
            var bcOptions = {reconnect: true};
            if(shardId) {
                bcOptions.extraParams = {
                    shardId: shardId
                };
            }
            ...
            this.socket = (function() {
                switch (socketImpl) {
                    case 'channel':
                        ...
                        return new BCSocket(host, bcOptions);
                    case 'sockjs':
